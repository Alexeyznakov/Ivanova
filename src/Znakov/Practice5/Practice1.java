...
import Znakov.Practice5.Exceptions.MyColumnException;
         ...
         while (true) {
             try {
                 ...
                 if(k<0||k>matrix.length-1){
                     throw new MyColumnException();
                 }
                 break;
             }catch (InputMismatchException ex){
                 System.out.println("Please inputo numbers. Try Again");
                 scanner.nextLine();
             }catch (MyColumnException ex){
